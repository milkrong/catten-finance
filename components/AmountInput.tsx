  ...
  return (
    <div className="relative">
        ...
        <Tooltip delayDuration={100}>
          <TooltipTrigger asChild>
            <button
              ...
              className={cn(
                "bg-slate-400 hover:bg-slate-500 absolute top-1.5 left-1.5 rounded-md",
                "p-2 flex items-center justify-center transition",
      ...
      <p className="text-muted-foreground mt-2 text-sm">
        {isIncome && "Will account for income"}
        {isExpense && "Will account for expenses"}
      </p>
    </div>
  );
};
